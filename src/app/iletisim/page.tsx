        ...
        <div className="relative py-24 bg-gray-900">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-300">
              Sorularınız ve randevularınız için bizimle iletişime geçin
            </p>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:grid lg:grid-cols-2 lg:gap-8">
                ...
                <div className="mt-8 space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="mt-1 text-base text-gray-500">
                        <a href="tel:+902161234567" className="hover:text-amber-600">
                          +90 (216) 123 45 67
                        </a>
                      </p>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="mt-1 text-base text-gray-500">
                        <a href="mailto:info@berber.com" className="hover:text-amber-600">
                          info@berber.com
                        </a>
                      </p>
                    </div>
              ...
              <div className="mt-12 lg:mt-0">
                ...
                <p className="mt-3 text-lg text-gray-500">
                  Sorularınız, önerileriniz veya randevu talepleriniz için formu doldurun.
                </p>
        ...
        <div className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 rounded-lg overflow-hidden shadow-xl h-96">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3011.6504900120997!2d29.0307!3d40.9907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDDCsDU5JzI2LjUiTiAyOcKwMDEnNTAuNSJF!5e0!3m2!1str!2str!4v1620000000000!5m2!1str!2str"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
