      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center text-2xl font-bold text-white mb-4">
              <span className="text-amber-500">Berber</span>
              <span>Studio</span>
            </div>
            <p className="text-gray-400 mb-4">
              Premium saç kesimi, sakal şekillendirme ve erkek bakım hizmetleri.
              Profesyonel ekibimizle kaliteli hizmet sunuyoruz.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li className="flex">
                ...
                <span className="text-gray-400">info@berberstudio.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {currentYear} Berber Studio. Tüm hakları saklıdır.
          </p>
        </div>
      </div>
    </footer>
