...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Burada form verilerini işleyerek backend'e gönderme işlemi yapılacaktır
            ...
            <div className="bg-white py-10 px-6 shadow-xl rounded-lg sm:px-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    ...
                    >
                      ...
                      <option value="beard">Sakal Şekillendirme</option>
                      <option value="skincare">Cilt Bakımı</option>
                      <option value="coloring">Saç Boyama</option>
                      <option value="kids">Çocuk Saç Kesimi</option>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-amber-600 hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
                  >
                    Gönder
                  </button>
                </div>
